...
// Text Fields section
  AFW::createSection( 'AFWtaxonomy', [
    ...
    'fields' => [
      ...
      [ 'title'=> __('Radio', 'AbuFramework'), 'subtitle' => __('subtitle', 'AbuFramework'), 'type' => 'radio', 'id' => 'radio', 'options' => [ __('Zebra', 'AbuFramework'), __('Dogs', 'AbuFramework'), __('Cats', 'AbuFramework'), __('Monkeys', 'AbuFramework') ] ],
